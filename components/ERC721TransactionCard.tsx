...
import { ERC721Transaction } from "../utils/types";
import { approveERC721Transaction } from '../controllers/ERC721TransactionController';

TimeAgo.setDefaultLocale(en.locale);
TimeAgo.addLocale(en);

interface ERC721TransactionCardProps {
  txn: ERC721Transaction;
  walletAddr: string;
}

const ERC721TransactionCard = ({
  txn,
  walletAddr,
}: ERC721TransactionCardProps) => {
      ...
      {txn.txnStatus == "EXECUTED" ? (
        ...
        <div className="flex gap-4">
          <button
            ...
            onClick={() => {
              if (signer)
                approveERC721Transaction(signer.signer, walletAddr, txn.id);
            }}
          >
            Approve
          </button>
...
export default ERC721TransactionCard;